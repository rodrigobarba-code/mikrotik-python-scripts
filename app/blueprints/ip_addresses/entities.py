# Description: IP Addresses Entities
...
class IPSegmentEntity:
    ...
    def validate_ip_segment(self):
        try:
            ...
            assert isinstance(self.ip_segment_id, int)  # Verify if IP Segment ID is an Integer
            ...
            assert isinstance(self.ip_segment_tag, str is IPSegmentTag.PUBLIC_IP or IPSegmentTag.PRIVATE_IP or IPSegmentTag.INTERN_CONNECTION)  # Verify if IP Segment Tag is a String
